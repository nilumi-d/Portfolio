...
export default function Engineering() {
  return (
    <section id="engineering" className="section-padding dark:bg-[#080b14] bg-slate-50 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 right-0 w-96 h-96 opacity-[0.04] bg-primary-600 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 left-0 w-80 h-80 opacity-[0.04] bg-teal-500 rounded-full blur-3xl" />
      </div>
      ...
      <div className="container-width">
        ...
        <FadeInUp delay={0.1} className="mb-12">
          <div className="p-6 sm:p-8 rounded-2xl border dark:border-primary-500/20 border-primary-200
            dark:bg-primary-500/[0.04] bg-primary-50 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 opacity-10 bg-primary-400 rounded-full blur-2xl" />
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <div>
                ...
                <p className="dark:text-gray-300 text-gray-700 text-sm leading-relaxed max-w-2xl">
                  ...
                  <span className="text-primary-600 dark:text-primary-400 font-semibold">maintainable, scalable, and secure</span>.
          ...
          <FadeInUp delay={0.2}>
            <div className="rounded-2xl dark:bg-white/[0.02] bg-white border dark:border-white/5 border-gray-100 overflow-hidden shadow-sm">
              <div className="flex items-center justify-between px-6 py-4 border-b dark:border-white/5 border-gray-100">
                ...
                <span className="px-2.5 py-1 rounded-full bg-primary-100 dark:bg-primary-500/10 text-primary-700 dark:text-primary-400 text-xs font-semibold border dark:border-primary-500/20 border-primary-200">
                ...
                {toolPlaceholders.map((tool, i) => (
                  <motion.div
                    ...
                    className="p-3 rounded-xl dark:bg-white/5 bg-gray-50 border dark:border-white/5 border-gray-100
                      dark:hover:border-primary-500/30 hover:border-primary-300 transition-all duration-300 cursor-default"
                  >
                    ...
                    <span className="mt-2 inline-block px-2 py-0.5 rounded-full
                      dark:bg-primary-500/10 bg-primary-100 dark:text-primary-400 text-primary-700
                      text-xs border dark:border-primary-500/20 border-primary-200">
                      {tool.status}
                    </span>
                  </motion.div>
                ))}
